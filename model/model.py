...
class TRICSS(BaseModel):
    def __init__(self, opt):
        ...
        if opt['path']['resume_state'] is not None and opt['phase']=='train':
            ...
            t=torch.rand(256,256,dtype=torch.float).unsqueeze(0).cuda()
    ...
    def optimize_parameters(self, ce=1):
        ...
        if ce<=15:
            print('only considering l1_loss')
            l_cyc=l_cyc1
        else:
            print('Now optimizing all losses')
    ...
    ################## for discriminators ###########################
        ...
        l_adv_D2 = self.backward_D_basic(self.netD2, self.data['F'],mask_V) * 0.1
    ...
    ###################training the generators ########################
        ...
        l_adv_G2 = self.netG.loss_gan(self.netD2(self.mask_V), True) * 0.1
        ...
        self.log_dict['l_adv_D2'] = l_adv_D2.item()
