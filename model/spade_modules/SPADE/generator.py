...
from .scta_main import SCTA_main
class SPADEGenerator(BaseNetwork):
    ...
    # encoder
        ...
        self.SCTA_1=SCTA_main(nf, nf*2,downsample=2)
        self.SCTA_2=SCTA_main(nf*2, nf*4,downsample=2)
    ...
    def forward(self, input, seg=None):
        ...
        x=self.SCTA_2(self.SCTA_1(self.model(input)))
